...
func ValidateTopUpQuotaCapacity(userId int, creditedQuota int) error {
	...
	maxCurrentQuota := int64(common.MaxWalletQuota) - spendableCredit
...
func creditTopUpQuota(tx *gorm.DB, userId int, creditedQuota int, updates map[string]interface{}) (int, error) {
	...
	quotaDelta, err := creditUserQuotaWithLimitTx(tx, userId, creditedQuota, common.MaxWalletQuota)
...
func RechargeEpay(tradeNo string, actualPaymentMethod string, callerIp string) (alreadyDone bool, err error) {
	...
	syncCreditUserQuotaCache(topUp.UserId, creditedQuota, "epay topup")
...
func Recharge(referenceId string, customerId string, callerIp string) (err error) {
	...
	syncCreditUserQuotaCache(topUp.UserId, creditedQuota, "stripe topup")
...
func RechargeCreem(referenceId string, customerEmail string, customerName string, callerIp string) (err error) {
	...
	syncCreditUserQuotaCache(topUp.UserId, creditedQuota, "creem topup")
...
func RechargeWaffo(tradeNo string, callerIp string) (err error) {
	...
	syncCreditUserQuotaCache(topUp.UserId, creditedQuota, "waffo topup")
...
func RechargeWaffoPancake(tradeNo string) (err error) {
	...
	syncCreditUserQuotaCache(topUp.UserId, creditedQuota, "waffo pancake topup")
