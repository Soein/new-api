...
// Write failures are logged and returned so destructive callers can require persistence.
func RecordAuditLog(c *gin.Context, entry AuditLog) error {
	...
	if LOG_DB == nil {
		err := errors.New("log database unavailable")
