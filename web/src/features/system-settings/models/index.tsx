...
const defaultModelSettings: ModelSettings = {
  ...
  FrtBreakerEnabled: false,
  FrtBreakerThresholdSec: 15,
  FrtBreakerStrikes: 3,
  FrtBreakerWindowSec: 300,
  FrtBreakerCooldownSec: 600,
  FrtBreakerHalfOpenEnabled: false,
  FrtBreakerHalfOpenWindowSec: 300,
  FrtBreakerHalfOpenStrikes: 1,
  FrtBreakerHalfOpenSweepSec: 30,
