...
func GenerateAccessToken(c *gin.Context) {
	...
	if err := model.UpdateUserAccessToken(id, common.GetContextKeyString(c, constant.ContextKeyUserSessionGeneration), key); err != nil {
		writeSecurityOperationError(c, err)
		return
	}
...
func RevokeAccessToken(c *gin.Context) {
	...
	ref, err := model.RevokeUserAccessToken(c.GetInt("id"), common.GetContextKeyString(c, constant.ContextKeyUserSessionGeneration))
	if err != nil {
		writeSecurityOperationError(c, err)
		return
	}
