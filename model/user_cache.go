...
// InvalidateUserCache clears cached authentication data after controller-level
// user state changes that are committed through batch operations.
func InvalidateUserCache(userId int) error {
...
func cacheGetUserBase(userId int) (*UserBase, error) {
	...
	if userCache.Id != userId || userCache.CacheSchema != userCacheSchemaVersion || userCache.AuthVersion <= 0 || userCache.SessionGeneration == "" {
