...
func smokeTestExpr(exprStr string) error {
	...
	vectors := []billingexpr.TokenParams{
		...
		{P: 300, C: 100, Len: 1000, CR: 100, Img: 400, ImgCR: 200, ImageCount: 1},
		{P: 800, C: 50, Len: 1000, AI: 200, AO: 50, ImageCount: 1},
		{Len: math.MaxInt32, ImgCR: math.MaxInt32, ImageCount: 1},
	}
