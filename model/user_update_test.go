...
func TestUpdateUserAccessTokenOnlyUpdatesAccessToken(t *testing.T) {
	...
	require.NoError(t, UpdateUserAccessToken(user.Id, user.SessionGeneration, "rotated-token"))
...
func TestUpdateUserAccessTokenRejectsSoftDeletedUser(t *testing.T) {
	...
	err := UpdateUserAccessToken(user.Id, user.SessionGeneration, "orphaned-token")
