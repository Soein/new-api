...
func recordManageAudit(c *gin.Context, action string, params map[string]any) error {
...
func recordManageAuditFor(c *gin.Context, targetUserId int, action string, params map[string]any) error {
	if params == nil {
