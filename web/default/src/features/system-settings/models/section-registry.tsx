    ...
    build: (settings: ModelSettings) => (
      <RoutingReliabilitySection
        defaultValues={{
          ...
          FrtBreakerEnabled: settings.FrtBreakerEnabled,
          FrtBreakerThresholdSec: settings.FrtBreakerThresholdSec,
          FrtBreakerStrikes: settings.FrtBreakerStrikes,
          FrtBreakerWindowSec: settings.FrtBreakerWindowSec,
          FrtBreakerCooldownSec: settings.FrtBreakerCooldownSec,
          FrtBreakerHalfOpenEnabled: settings.FrtBreakerHalfOpenEnabled,
          FrtBreakerHalfOpenWindowSec: settings.FrtBreakerHalfOpenWindowSec,
          FrtBreakerHalfOpenStrikes: settings.FrtBreakerHalfOpenStrikes,
          FrtBreakerHalfOpenSweepSec: settings.FrtBreakerHalfOpenSweepSec,
